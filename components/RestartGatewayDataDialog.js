  ...
  return (
      <Portal>
        <Dialog
          ...
          <Dialog.Content>
            <Text>Starting new gateway service will overwrite the data readings from previous gateway session. Are you sure you want to overwrite previous data?</Text>
          </Dialog.Content>
